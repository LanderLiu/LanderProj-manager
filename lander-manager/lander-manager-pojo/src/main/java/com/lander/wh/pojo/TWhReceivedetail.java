...
public class TWhReceivedetail implements Serializable {
    /**
     * 主键
     */
    private Long fid;
    ...
    /**
     * 对应的订单分录ID，取自t_pr_orderitem，可为空，表示没有上游单据。
     */
    private Long forderitemid;
    ...
    public Long getForderitemid() {
        return forderitemid;
    }

    public void setForderitemid(Long forderitemid) {
        this.forderitemid = forderitemid;
    }
    ...
    public String toString() {
        ...
        sb.append(", forderitemid=").append(forderitemid);

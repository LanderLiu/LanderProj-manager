...
public class TWhReceive implements Serializable {
    /**
     * 主键
     */
    private Long fid;
    ...
    /**
     * 如果来源是采购订单，则此值关联取自 t_pr_orde，冗余存储。
结合t_wh_receivedetail:forderitemid,也就是一张订单的一条分录，可以分多次收货。可分布在多张收货单的多张分录。
由于收货单主表与订单有关联，所以同一收货单的各分录，对应的采购订单分录，必须属于同一订单
     */
    private Long forderid;

    /**
     * 收货来源类型：0：无上游单据，手工新增    1:来自采购订单
     */

...
public class TWhCheckdetail implements Serializable {
    /**
     * 主键
     */
    private Long fid;
    ...
    public BigDecimal getFqtyfact() {
        return fqtyfact;
    }

    public void setFqtyfact(BigDecimal fqtyfact) {
        this.fqtyfact = fqtyfact;
    }
    ...
    public String toString() {
        ...
        sb.append(", fqtyfact=").append(fqtyfact);

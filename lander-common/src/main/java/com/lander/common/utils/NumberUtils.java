...
public class NumberUtils {
	 ...
	 * @return
	 */
	public static boolean isDigit(CharSequence value) {
	 ...
	 * @return
	 */
	public static String format(CharSequence value, Integer precision) {
		Double number = 0.0;
	 ...
	 * @return
	 */
	public static Double parseDouble(CharSequence value, Double replace) {
		if (!NumberUtils.isDigit(value)) {
			return replace;
		}
